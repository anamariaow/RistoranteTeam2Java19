...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Vino domPerignon = new Vino("Champagne Brut Vintage - Dom Pérignon", 300.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Bollicina", "Uve - Pinot Nero Chardonnay | Abbinamento - Pesce e crostacei | Alcool - 12.5%", "Champagne, Francia", 2013);
        Vino deVilmont = new Vino("Champagne Brut Réserve Premier Cru - De Vilmont", 50.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bollicina", "Uve - Chardonnay Pinot Nero Meunier | Abbinamento - Pesce e crostacei | Alcool - 12.5%", "Champagne, Francia", 2020);
        Vino veuveClicquot = new Vino("Champagne Brut Cuvée Saint Petersbourg - Veuve Clicquot", 70.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Bollicina", "Uve - Pinot Nero Chardonnay Meunier | Abbinamento - Pesce e crostacei | Alcool - 12%", "Champagne, Francia", 2020);
        Vino serenaWines = new Vino("Prosecco Rosé Vigner - Serena Wines", 25.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bollicina", "Uve - Glera Pinot Nero | Abbinamento - Salumi | Alcool - 11%", "Veneto, Italia", 2022);
        Vino francoisDiligent = new Vino("Champagne Nature Meunier Frqncois Diligent", 100.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Bollicina", "Uve - Meunier | Abbinamento - Pesce e crostacei | Alcool: 12.5%", "Champagne, Francia", 2017);
        Vino colVetoraz = new Vino("Prosecco Valdobbiadene Superiore Extra Dry - Col Vetoraz", 90.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Bollicina", "Uve - Timorasso | Abbinamento - Salumi | Alcool - 11.5%", "Veneto, Italia", 2022);

        //selezione di vini bianchi
        Vino hofstatter = new Vino("Alto Adige Gewürztraminer Kolbenhof - Hofstatter", 50.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bianco", "Uve - Gewürztraminer | Abbinamento - Pesce e crostacei | Alcool - 15%", "Alto Adige, Italia", 2021);
        Vino vignetiMassa = new Vino("Colli Tortonesi Timorasso Sterpi - Vigneti Massa", 70.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bianco", "Uve - Timorasso | Abbinamento - Pesce e crostacei | Alcool - 15%", "Piemonte, Italia", 2021);
        Vino bossanova = new Vino("Trebbiano d'Abruzzo - Bossanova", 35.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bianco", "Uve - Trebbiano | Abbinamenti - Pesce e crostacei | Alcool - 12%", "Abruzzo, Italia", 2022);
        Vino tascaDAlmerita = new Vino("Contea di Sclafani Chardonnay Vigna San Francesco - Tasca D'Almerita", 55.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bianco", "Uve - Chardonnay | Abbinamento - Formaggi | Alcool - 14%", "Sicilia, Italia", 2021);
        Vino damijan = new Vino("Venezia Giulia Ribolla Gialla - Damijan", 60.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bianco", "Uve - Ribolla Gialla | Abbinamento - Carni bianche e verdure | Alcool - 13.5%", "Friuli-Venezia Giulia, Italia", 2019);
        Vino girlan = new Vino("Alto Adige Pinot Bianco Platt & Riegl - Girlan", 20.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTOCINQUANTA,"Bianco", "Uve - Pinot Bianco | Abbinamento - Carni bianche e verdure | Alcool - 14%", "Alto Adige, Italia", 2022);

        //selezione di vini rossi
        Vino bennati = new Vino("Valpolicella Ripasso Superiore Sfojà - Bennati", 30.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO, "Rosso", "Uve - Corvina Corvinone Rondinella | Abbinamento - Carni rosse | Alcool - 14%", "Veneto, Italia", 2021);
        Vino donnafugata = new Vino("Sicilia Mille e una Notte - Donnafugata", 80.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Rosso", "Uve - Nero d'Avola Petit Verdot Syrah | Abbinamento - Carni rosse | Alcool - 13.5%", "Sicilia, Italia", 2019);
        Vino pandolfa = new Vino("Rubicone Sangiovese Ginevra - Pandolfa", 25.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Rosato", "Uve - Sangiovese | Abbinamento - Carni bianche e verdure | Alcool - 12%", "Emilia Romagna, Italia", 2022);
        Vino montepulciano = new Vino("Montepulciano d'Abbruzzo - Bossanova", 35.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Rosso", "Uve - Montepulciano | Abbinamento - Carni bianche e verdure | Alcool - 13.5%", "Abbruzzo, Italia", 2021);
        Vino cavalchina = new Vino("Bardolino - Cavalchina", 20.00, new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Rosso", "Uve - Corvina Rondinella Molinara | Abbinamento - Salumi | Alcool - 12.5%", "Veneto, Italia", 2022);
        Vino villaSpinosa = new Vino("Recioto Classico della Valpolicella Francesca Finato - Villa Spinosa", 40.00,new ArrayList<>(List.of(AllergeneEnum.SOLFITI)),CalorieEnum.CENTO,"Rosso", "Uve - Corvina Veronese Corvinone Rondinella | Abbinamento - Formaggi | Alcool - 15%", "Veneto, Italia", 2019);
