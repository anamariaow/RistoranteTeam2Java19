...
public class Main {
    public static void main(String[] args) {
        ...
        Vino villaSpinosa = new Vino("Recioto Classico della Valpolicella Francesca Finato Spinosa - Villa Spinosa", 40.00, "Uve:  Corvina Veronese Corvinone Rondinella, Abbinamento: Formaggi, Alcool: 15%", "Veneto, Italia", 2019);
